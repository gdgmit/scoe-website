  ...
  <div class="forms-form-wrapper">
    <form id="myform" method="post" enctype="multipart/form-data">
      ...
      <div class="forms-mb-3">
        ...
        <input type="date" name="dob" id="dob" class="forms-form-input"required />
      </div>
      ...
      <div class="forms-mb-3">
        ...
        <select class="forms-form-input" name="gender" id="gender" required>
      ...
      <div class="forms-mb-3">
        ...
        <select class="forms-form-input" name="diff_abled" id="diff_abled" required>
      ...
      <div class="forms-mb-3">
        ...
        <select class="forms-form-input" name="martial_status" id="martial_status" required>
      ...
      <div class="forms-mb-3">
        ...
        <select class="forms-form-input" name="category" id="category" required>
      ...
      <div class="forms-mb-3">
        ...
        <select class="forms-form-input" name="area" id="area" required>
      ...
      <div class="forms-mb-3">
        ...
        <input
          ...
          name="reg_num"
          id="reg_num"
          placeholder="College Registration Number / Employee ID"
          class="forms-form-input"
          required
        />
      </div>
      ...
      <div class="forms-mb-3">
        ...
        <input
          ...
          name="file"
          id="upload"
          class="forms-form-input forms-form-file"
          required
        />
      </div>
